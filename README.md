...
#### 株式会社MIXI - ベッティングアプリのREST APIサーバーの開発・保守運用ならびにSRE業務(2020/02 〜 2025/08)
- 担当領域
...
#### 株式会社MIXI - 社内Chatbotの開発(2023/03 〜 2025/03)
- 担当領域
...
#### 新東電算株式会社 - 放送業界で用いるLinuxサーバー内で動作するアプリケーション開発(2019/04 〜 2020/01)
- 担当領域
  - 要件定義, 設計, コーディング, テスト
- 概要
