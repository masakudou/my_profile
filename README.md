...
### 正社員のお誘いについて
- 現在一切の正社員オファーについて受け付けておりません。

### 副業のお誘いについて
- 副業の話はいつでもお待ちしております。
  - 夜間・休日稼働が主になります。
    - 現在あまり副業に時間が裂けないため、月20時間程度でもOKな場合のみ受け付けます。
  - 単価は仕事内容にもよりますが、現状の正社員としての給料から換算し下限¥7,500〜くらいで探しています。
...
- Google Cloud Platformの運用
  ...
  - コスト削減
  - モニタリング・ロギング・アラート
- ゼロトラストネットワークの構築 with Cloudflare
...
- 2025/12 ColorSing株式会社と業務委託契約(副業)
...
#### ColorSing株式会社 - シニアバックエンドエンジニア(2025/12 〜 )
- 担当領域
  - バックエンドエンジニア。設計, コーディング, 運用・保守
- 概要
  - バックエンドエンジニアとして、gRPCを利用した歌配信アプリケーションの開発に従事。
